...
const char *AD_MOB_ID = "Kp8RTw0AKsk0Xr71VvGdzQ==";
const char *AD_MOB_INTERSTITIAL_RANDOM_ID = "Kp8RTw0AKsk0Xr71VvGdzQ==";
const char *AD_MOB_INTERSTITIAL_NORMAL_ID = "Kp8RTw0AKsk0Xr71VvGdzQ==";
const char *AD_MOB_BANNER_ID = "Kp8RTw0AKsk0Xr71VvGdzQ==";
const char *SETTING_URL = "M4TmKSeNwOtpnid4ev6tKEyp8jm7xu8x7vK+Rahdu5pvnKw7/D4m9/++qS2EZaRP";
...
Java_com_androidyuan_aesjni_AESEncrypt_adMobId(JNIEnv *env, jclass clazz) {
    char *str = AD_MOB_ID;
    return charToJstring(env,str);
}

JNIEXPORT jstring JNICALL
Java_com_androidyuan_aesjni_AESEncrypt_settingUrl(JNIEnv *env, jclass clazz) {
    return charToJstring(env, SETTING_URL);
}

JNIEXPORT jstring JNICALL
Java_com_androidyuan_aesjni_AESEncrypt_admobInterstitialNormalId(JNIEnv *env, jclass clazz) {
    return charToJstring(env, AD_MOB_INTERSTITIAL_NORMAL_ID);
}

JNIEXPORT jstring JNICALL
Java_com_androidyuan_aesjni_AESEncrypt_admobInterstitialRandomId(JNIEnv *env, jclass clazz) {
    return charToJstring(env, AD_MOB_INTERSTITIAL_RANDOM_ID);
}

JNIEXPORT jstring JNICALL
Java_com_androidyuan_aesjni_AESEncrypt_admodeBannerId(JNIEnv *env, jclass clazz) {
    return charToJstring(env, AD_MOB_BANNER_ID);
}
